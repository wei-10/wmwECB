...
def parse_option():
    ...
    parser.add_argument('--cfg', type=str,  metavar="FILE", default='./configs/swin/swin_tiny_patch4_window7_mask56_224_alpha1.yaml',help='path to config file', )
    parser.add_argument(
        "--opts",
...
if __name__ == '__main__':
 ...
 #       assert amp is not None, "amp not installed!"
    ...
    linear_scaled_lr=0.01
    linear_scaled_warmup_lr=0.01
    linear_scaled_min_lr=0.01
